...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'URLCheck'
        db.create_table(u'monitor_urlcheck', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('url', self.gf('django.db.models.fields.URLField')(max_length=200)),
            ('last_checked', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, blank=True)),
        ))
        db.send_create_signal(u'monitor', ['URLCheck'])


    def backwards(self, orm):
        # Deleting model 'URLCheck'
        db.delete_table(u'monitor_urlcheck')

...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'SiteToSkip'
        db.create_table(u'monitor_sitetoskip', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('host', self.gf('django.db.models.fields.CharField')(unique=True, max_length=253)),
        ))
        db.send_create_signal(u'monitor', ['SiteToSkip'])

        # Adding model 'Plan'
        db.create_table(u'monitor_plan', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(unique=True, max_length=32)),
            ('max_requests', self.gf('django.db.models.fields.PositiveIntegerField')()),
            ('price', self.gf('django.db.models.fields.FloatField')()),
        ))
        db.send_create_signal(u'monitor', ['Plan'])
    ...
    def backwards(self, orm):
        # Deleting model 'SiteToSkip'
        db.delete_table(u'monitor_sitetoskip')

        # Deleting model 'Plan'
        db.delete_table(u'monitor_plan')

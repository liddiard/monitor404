...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'UserPrefs.plan'
        db.alter_column(u'monitor_userprefs', 'plan_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['monitor.Plan']))

    def backwards(self, orm):

        # Changing field 'UserPrefs.plan'
        db.alter_column(u'monitor_userprefs', 'plan_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['monitor.Plan'], null=True))
    ...
    models = {
        ...
        u'monitor.userprefs': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'plan': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['monitor.Plan']"}),

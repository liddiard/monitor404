...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'monitor_usersite', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'])),
            ('host', self.gf('django.db.models.fields.CharField')(max_length=253)),
        ))
        db.send_create_signal(u'monitor', ['UserSite'])

        # Adding model 'LogEntry'
        db.create_table(u'monitor_logentry', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('site', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['monitor.UserSite'])),
        ...
        db.send_create_signal(u'monitor', ['LogEntry'])


    def backwards(self, orm):
        # Deleting model 'UserSite'
        db.delete_table(u'monitor_usersite')

        # Deleting model 'LogEntry'
        db.delete_table(u'monitor_logentry')

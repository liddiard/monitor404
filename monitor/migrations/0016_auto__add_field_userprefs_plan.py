...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'monitor_userprefs', 'plan',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['monitor.Plan'], null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'UserPrefs.plan'
        db.delete_column(u'monitor_userprefs', 'plan_id')
    ...
    models = {
        ...
        u'monitor.userprefs': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'plan': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['monitor.Plan']", 'null': 'True'}),

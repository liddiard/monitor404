...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'UserPrefs.email_interval'
        db.delete_column(u'monitor_userprefs', 'email_interval')

        # Adding field 'UserPrefs.email_404'
        db.add_column(u'monitor_userprefs', 'email_404',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)

        # Adding field 'UserPrefs.email_quota'
        db.add_column(u'monitor_userprefs', 'email_quota',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'UserPrefs.email_interval'
        db.add_column(u'monitor_userprefs', 'email_interval',
                      self.gf('django.db.models.fields.PositiveIntegerField')(default=2),
                      keep_default=False)

        # Deleting field 'UserPrefs.email_404'
        db.delete_column(u'monitor_userprefs', 'email_404')

        # Deleting field 'UserPrefs.email_quota'
        db.delete_column(u'monitor_userprefs', 'email_quota')

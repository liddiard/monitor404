...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'UserSite.requests_today'
        db.add_column(u'monitor_usersite', 'requests_today',
                      self.gf('django.db.models.fields.PositiveIntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'UserSite.requests_today'
        db.delete_column(u'monitor_usersite', 'requests_today')

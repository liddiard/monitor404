...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'UserPrefs.email_interval'
        db.alter_column(u'monitor_userprefs', 'email_interval', self.gf('django.db.models.fields.PositiveIntegerField')())

    def backwards(self, orm):

        # Changing field 'UserPrefs.email_interval'
        db.alter_column(u'monitor_userprefs', 'email_interval', self.gf('django.db.models.fields.IntegerField')())

...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'UserPrefs.timezone'
        db.alter_column(u'monitor_userprefs', 'timezone', self.gf('timezone_field.fields.TimeZoneField')())

    def backwards(self, orm):

        # Changing field 'UserPrefs.timezone'
        db.alter_column(u'monitor_userprefs', 'timezone', self.gf('django.db.models.fields.IntegerField')())

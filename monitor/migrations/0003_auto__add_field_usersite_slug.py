...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'UserSite.slug'
        db.add_column(u'monitor_usersite', 'slug',
                      self.gf('django.db.models.fields.SlugField')(default='site', max_length=253),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'UserSite.slug'
        db.delete_column(u'monitor_usersite', 'slug')

...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'UserPrefs.timezone'
        db.delete_column(u'monitor_userprefs', 'timezone')

        # Adding field 'UserPrefs.time_zone'
        db.add_column(u'monitor_userprefs', 'time_zone',
                      self.gf('timezone_field.fields.TimeZoneField')(default='America/Los_Angeles'),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'UserPrefs.timezone'
        db.add_column(u'monitor_userprefs', 'timezone',
                      self.gf('timezone_field.fields.TimeZoneField')(default='America/Los_Angeles'),
                      keep_default=False)

        # Deleting field 'UserPrefs.time_zone'
        db.delete_column(u'monitor_userprefs', 'time_zone')

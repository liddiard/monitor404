...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'monitor_userpreferences', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('user', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['auth.User'], unique=True)),
            ('timezone', self.gf('django.db.models.fields.IntegerField')(default=0)),
            ('email_interval', self.gf('django.db.models.fields.IntegerField')(default=2)),
        ))
        db.send_create_signal(u'monitor', ['UserPreferences'])


    def backwards(self, orm):
        # Deleting model 'UserPreferences'
        db.delete_table(u'monitor_userpreferences')
    ...
    models = {
        ...
        u'monitor.userpreferences': {
            'Meta': {'object_name': 'UserPreferences'},
            'email_interval': ('django.db.models.fields.IntegerField', [], {'default': '2'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
